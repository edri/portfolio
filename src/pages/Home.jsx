    ...
    <>
      <section className="before:bg-grey-transparent before:absolute before:inset-0 before:z-0 relative h-screen bg-white bg-miguel bg-contain bg-no-repeat bg-right-bottom font-roboto">
        <div className="relative flex flex-col justify-center text-center h-full w-9/12 text-white z-10">
          <h2 className="text-5xl font-thin mb-4 xl:text-7xl">Hello, I&apos;m</h2>
          <h1 className="text-5xl font-bold mb-8 xl:text-7xl">Miguel Santamaria</h1>
          <h3 className="text-2xl font-thin mb-20 xl:text-4xl">and this is my resume.</h3>
          <div className="flex items-center bg-dark-grey cursor-pointer w-12 h-12 rounded-full mx-auto transition-colors duration-300 hover:bg-dark-brown xl:w-16 xl:h-16">
            <ChevronDownIcon className="mx-auto size-8 xl:size-12 text-current" />
          </div>
        </div>
      </section>
      <section className="text-white px-48 py-12">
