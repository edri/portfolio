...
export default function SkillsSection() {
  return (
    <>
      <SubSection title="Languages" IconComponent={FaCode} marginTop="mt-8">
        <div>
          <ul>
            <Skill
      ...
      <SubSection title="Frontend" IconComponent={RiImageEditFill} marginTop="mt-8">
        <div>
          <ul>
            <Skill
      ...
      <SubSection title="Backend" IconComponent={FaServer} marginTop="mt-8">
        <div>
          <ul>
      ...
      <SubSection title="Database" IconComponent={FaDatabase} marginTop="mt-8">
        <div>
          <ul>
      ...
      <SubSection title="Operating Systems" IconComponent={TbDeviceImacCog} marginTop="mt-8">
        <div>
          <ul>
      ...
      <SubSection title="Miscellaneous" IconComponent={MdMiscellaneousServices} marginTop="mt-8">
        <div>
          <ul>
